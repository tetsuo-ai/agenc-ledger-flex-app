...
#define ICON_HOME      C_home_agenc_14px
#define ICON_SIGN_MENU C_home_agenc_white_14px
#define ICON_WARNING   C_icon_warning
#define ICON_REVIEW    C_icon_certificate
#elif defined(TARGET_STAX) || defined(TARGET_FLEX)
#define ICON_HOME      C_home_agenc_64px
#define ICON_SIGN_MENU C_home_agenc_64px
#define ICON_WARNING   C_Warning_64px
#define ICON_REVIEW    C_Review_64px
#elif defined(TARGET_APEX_P)
#define ICON_HOME      C_home_agenc_48px
#define ICON_SIGN_MENU C_home_agenc_48px
